...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Edit Jadwal Piket Pegawai</h1>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
</div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Edit Data Jadwal Piket Pegawai</h3>
                    </div>
                    <form method="post" action="/jadwal_piket/{{$jadwal->id}}">
                        @method('patch')
                        @csrf
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" id="tanggal" name="tanggal" class="form-control" placeholder="Tanggal-Bulan-Tahun" required value="{{\Carbon\Carbon::parse($jadwal->tanggal)->format('d-m-Y')}}">
