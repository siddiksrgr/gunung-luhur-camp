        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="/user/admin">Admin</a></li>
...
<section class="content">
    ...
    <div class="card card-default">
        <div class="card-header">
            <h3 class="card-title">Ganti Password Admin</h3>
        </div>
        <!-- /.card-header -->
        <!-- form start -->
        <form method="post" action="/user/admin/{{$user->id}}/updatePasswordAdmin" enctype="multipart/form-data">
            @method('patch')
            @csrf
            <div class="card-body">
                <div class="row">
            ...
            <div class="card-footer">
                ...
                <a href="/user/admin"><button type="button" class="btn btn-secondary"><i class="fas fa-window-close"></i> Cancel</button></a>
            </div>
        </form>
    </div>
