        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="/penyewaan_tambahan">Penyewaan Alat</a></li>
...
<section class="content">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            @if(!empty($sewaAlatTambah->sewaAlat->pengembalian))
            <div class="row">
                <div class="col-2">
                    <p>Tanggal Pengembalian</p>
                </div>
                <div class="col-10">
                    <p>: {{\Carbon\Carbon::parse($sewaAlatTambah->sewaAlat->pengembalian->tanggal_input)->format('d-m-Y')}}</p>
                </div>
            </div>
            <div class="row">
                <div class="col-2">
                ...
                <div class="col-10">
                    <p>: {{$sewaAlatTambah->sewaAlat->pengembalian->jumlah_kembali}}</p>
                </div>
            </div>
            <div class="row">
                <div class="col-2">
                ...
                <div class="col-10">
                    <p>: {{$sewaAlatTambah->sewaAlat->pengembalian->jumlah_bagus}}</p>
                </div>
            </div>
            <div class="row">
                <div class="col-2">
                ...
                <div class="col-10">
                    <p>: {{$sewaAlatTambah->sewaAlat->pengembalian->jumlah_rusak}}</p>
                </div>
            </div>
            @endif
